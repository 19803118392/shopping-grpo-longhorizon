...
from web_agent_site.engine.reward_features_v1 import compile_reward_features
...
from web_agent_site.engine.variant_price_v1 import (
...
class RewardV3Test(unittest.TestCase):
    ...
    def test_missing_contract_does_not_invalidate_reward_v3(self):
        task_goal = goal()
